...
class Ui_MainWindow(object):
    def __init__(self):
        self.sourceimgpath = "examples/in/daxiongmao.jpg"
        self.saveimgname = "test.jpg"
        self.sourcevideopath = 'examples/in/fox.mp4'
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_name.setText("")#小组成员姓名
        ...
        pixmap1 = QPixmap('examples/style/la_muse.jpg')
        ...
        pixmap1 = QPixmap('examples/style/rain_princess.jpg')
        ...
        pixmap1 = QPixmap('examples/style/the_scream.jpg')
        ...
        pixmap1 = QPixmap('examples/style/qibaishi.jpg')
        self.SIlabel3.setPixmap(pixmap1)
        self.SIlabel3.setScaledContents(True)
        ...
        pixmap1 = QPixmap('examples/style/panda.jpg')
        self.SIlabel3.setPixmap(pixmap1)
        self.SIlabel3.setScaledContents(True)
        ...
        pixmap1 = QPixmap('examples/style/wreck.jpg')
        ...
        pixmap1 = QPixmap('examples/style/wave.jpg')
        ...
        pixmap1 = QPixmap('examples/style/udnie.jpg')
    ...
    def transimg(self):
        ...
        cmd1 = "/home/bly/anaconda2/bin/python evaluate.py --checkpoint models/"+imagestyle+".ckpt"+" --in-path "+self.sourceimgpath+" --out-path examples/out/"+self.saveimgname
    ...
    def tranvideo(self):
        ...
        #print(sourcevideo)
        cmd1 = "/home/bly/anaconda2/bin/python transform_video.py --in-path "+sourcevideo+" --checkpoint models/"+videostyle+".ckpt"+" --out-path examples/out/"+savevide+" --device /gpu:0 --batch-size "+batchsize
